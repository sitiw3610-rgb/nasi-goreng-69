...
export const FloatingWhatsApp = () => {
  const text = encodeURIComponent("Halo Nasi Goreng 69, saya ingin bertanya tentang menu.");
  return (
    <a
    ...
    >
      ...
      <span className="relative flex items-center gap-2 bg-[#25D366] hover:bg-[#1fb957] text-white pl-4 pr-5 py-3.5 rounded-full shadow-glow animate-float transition-all">
        ...
        <span className="hidden sm:inline text-sm font-semibold whitespace-nowrap">Chat Kami</span>
      </span>
    </a>
  );
};
